...
if [ -f "$CONFIG_FILE" ]; then
  ...
  echo ""
  echo "  For each digest (e.g., sa-digest), you need two Notion IDs:"
...
echo "  2. Open Claude Code and type /sa-digest to run your first digest"
echo "  3. Check your Notion database for the output"
echo ""
echo "To personalize: Edit profiles/sa-digest.md to describe your role and priorities"
