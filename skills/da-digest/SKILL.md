---
name: da-digest
description: Manually trigger the DA Daily Digest - scans hiero-ledger GitHub activity, Notion keywords, and partner conversations, writes a combined digest to Notion. Usage - /da-digest [YYYY-MM-DD]
user-invocable: true
---
...
**DA Daily Digest - hiero-ledger** | <DATE_LABEL>
