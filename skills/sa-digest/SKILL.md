...
The flags `--dry-run` and date arg can appear in any order. The dry-run output goes to `~/.config/team-digest/dry-runs/sa-digest-<DATE_LABEL>-v<N>.md`, versioned so repeated runs do not clobber each other.
