...
This profile tells the SA Daily Digest what matters to this team. Claude uses it to write the
"SA Relevance" section for each priority repo, tailoring the analysis to your actual role
...
Copy it to `sa-digest.md` (already done by setup.sh) and personalize it.
