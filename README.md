...
The output goes to `~/.config/team-digest/dry-runs/team-digest-<DATE>-v<N>.md`. Use this to validate refactors or preview a digest before doing a real run that overwrites a Notion page.
